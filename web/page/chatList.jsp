<!DOCTYPE html>
<!-- saved from url=(0067)http://139.196.210.151/1/json.php?mod=admin&act=dataList&1465824963 -->
<html lang="en">
<head>
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://139.196.210.151/1/index.html">Admin v2.0</a>
        </div>
        <!-- /.navbar-header -->
                    ...
                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                        <ul class="pagination">
                            ...
                            <li class="paginate_button active" tabindex="0"><a
                                    href="http://139.196.210.151/1/json.php?mod=admin&act=dataList&page=1">1</a></li>
                        ...
                        <div id="dataTables-example_filter" class="dataTables_filter">
                            ...
                            &nbsp;<a href="http://139.196.210.151/1/json.php?mod=admin&act=export" target="_blank">å¯¼åºæ°æ®</a>
                        </div>
                        <br><br>
                        <!-- <ul class="pagination">
